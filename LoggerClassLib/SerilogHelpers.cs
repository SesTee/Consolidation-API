            ...
            loggerConfig
                ...
                .WriteTo.Logger(lc => lc
                    ...
                    .WriteTo.MSSqlServer(
                        ...
                        autoCreateSqlTable: bool.Parse(config["Serilog:Connections:AutoCreateSqlTable"]),
                   ...
                   .WriteTo.Logger(lc => lc
                    ...
                    $@"{config["Serilog:Connections:InfoFileLogPath"]}\{applicationName}.json",
                    fileSizeLimitBytes: long.Parse(config["Serilog:Settings:FileSizeLimitBytes"]),
                    rollOnFileSizeLimit: true,
                    rollingInterval: RollingInterval.Day,
                    buffered: bool.Parse(config["Serilog:Settings:Buffered"]))) // change this to true to enhance performance be sure to test
                //.WriteTo.Logger(lc => lc
                ...
                .WriteTo.Logger(lc => lc
                    ...
                    .Filter.ByExcluding(Matching.WithProperty("Activity"))
                   .WriteTo.File(new CompactJsonFormatter(),
                    $@"{config["Serilog:Connections:ErrorFileLogPath"]}\{applicationName}.json",
                    fileSizeLimitBytes: long.Parse(config["Serilog:Settings:FileSizeLimitBytes"]),
                    rollOnFileSizeLimit: true,
                    rollingInterval: RollingInterval.Day,
                    buffered: bool.Parse(config["Serilog:Settings:Buffered"]))); // change this to true to enhance performance be sure to test
